...
output: 
    bookdown::gitbook:
        ...
        split_bib: TRUE
        df_print: paged
bibliography: [bookdown-demo-master/book.bib,bookdown-demo-master/packages.bib]
---
...
```{r,child="bookdown-demo-master/01-intro.Rmd"}
```

```{r,child="bookdown-demo-master/02-literature.Rmd"}
```
